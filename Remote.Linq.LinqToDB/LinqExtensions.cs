...
namespace Remote.Linq.LinqToDB
{
   public static class LinqExtensions
   {
      ...
      {
         return ((IExpressionQuery<T>)((ValueInsertable<T>)source).Query).DataContext.MappingSchema.ChangeTypeTo<int?>(InsertWithIdentity(source));
      }
      ...
      {
         return ((IExpressionQuery<T>)((ValueInsertable<T>)source).Query).DataContext.MappingSchema.ChangeTypeTo<long?>(InsertWithIdentity(source));
      }
      ...
      {
         return ((IExpressionQuery<T>)((ValueInsertable<T>)source).Query).DataContext.MappingSchema.ChangeTypeTo<decimal?>(InsertWithIdentity(source));
      }
         ...
         Expression<Func<TSource, TTarget>> setter)
      {
         ...
         return ((IExpressionQuery<TSource>)currentSource).DataContext.MappingSchema.ChangeTypeTo<int?>(
         ...
         Expression<Func<TSource, TTarget>> setter)
      {
         ...
         return ((IExpressionQuery<TSource>)currentSource).DataContext.MappingSchema.ChangeTypeTo<long?>(
            InsertWithIdentity(currentSource, target, setter));
      }
         ...
         Expression<Func<TSource, TTarget>> setter)
      {
         ...
         return ((IExpressionQuery<TSource>)currentSource).DataContext.MappingSchema.ChangeTypeTo<decimal?>(
            InsertWithIdentity(currentSource, target, setter));
      }
      ...
      {
         return ((IExpressionQuery<TSource>)((SelectInsertable<TSource, TTarget>)source).Query).DataContext.MappingSchema.ChangeTypeTo<int?>(
      ...
      {
         return ((IExpressionQuery<TSource>)((SelectInsertable<TSource, TTarget>)source).Query).DataContext.MappingSchema.ChangeTypeTo<long?>(
            InsertWithIdentity(source));
      }
      ...
      {
         return ((IExpressionQuery<TSource>)((SelectInsertable<TSource, TTarget>)source).Query).DataContext.MappingSchema.ChangeTypeTo<decimal?>(
            InsertWithIdentity(source));
      }
